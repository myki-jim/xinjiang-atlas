...
function renderRoutePanel() {
  ...
  const posterDownload = routeState.days === 7 && routeState.style === 'slow' && routeState.mode === 'drive' && routeState.pace === 'full'
    ? `<a class="fit-route poster-download" href="${import.meta.env.BASE_URL}exports/pamir-shache-7-day-road-trip.png" download="帕米尔与莎车-七日行进图.png">↓ 下载完整行进图 · 10000 × 7000</a>` : '';
